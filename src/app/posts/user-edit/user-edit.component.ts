...
import { ACrudService } from "src/app/common/services/acrud.service";
import { Subscription, Observable } from "rxjs";
import { UPost } from "src/app/common/models/UPost.model";
...
export class UserEditComponent implements OnInit {
  ...
  getPublicPosts() {
    ...
    this.isPublic = true;
    this.isPrivate = false;
    this.acrud.getPublicPost().subscribe(
      (data) => {
  ...
  getPriavtePosts() {
    ...
    this.isPublic = false;
    this.isPrivate = true;
    this.acrud.getPrivatePost().subscribe(
      (data) => {
        let x3 = this.acrud.seprate(data);
        this.d4 = x3;
